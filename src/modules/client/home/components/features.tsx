...
const features = [
  {
    ...
    description:
      "Our conversational AI gathers comprehensive patient data before visits, creating smart summaries for doctors.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Easily find doctors, book appointments, and integrate with your personal calendar in just a few clicks.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Engage in high-quality, secure virtual consultations with AI-powered clinical decision support.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Securely upload, store, and manage all your medical records in one place with our FileNest service.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Dedicated, intuitive dashboards for both patients and doctors to manage their healthcare journey.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Built on a foundation of security, compliant with HIPAA, GDPR, and other major healthcare standards.",
  },
];
      ...
      <div className="px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-lg text-landing-muted-foreground">
            Dr. Godly brings together cutting-edge technology to create a
            seamless and intelligent healthcare ecosystem for everyone involved.
          </p>
        </motion.div>
