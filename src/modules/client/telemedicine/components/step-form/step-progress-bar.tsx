...
export function StepProgressBar({
  ...
  return (
    <div className="w-full space-y-6">
      ...
      {/* Responsive Stepper */}
      {/* ────────────────────────────────────────────── */}
      <div className="flex no-scrollbar gap-4 sm:gap-2 max-w-full justify-between relative">
            ...
            <Fragment key={step.id}>
              ...
              >
                ...
                <button
                  ...
                  className={cn(
                    "flex flex-col items-center p-2 rounded-lg transition-all relative z-50",
